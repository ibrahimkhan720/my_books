            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="file" name="team_img" class="form-control" id="team_img" value="{{ $team->team_img }}">
                   ...
                   @enderror
                    ...
                    <div class="form-group @error('pinterest_id') has-error @enderror">
                        ...
                        <input type="text" name="pinterest_id" class="form-control" id="pinterest_id" placeholder="Pinterest ID" value="{{ $team->twitter_id }}">
                    @error('pinterest_id')
                   <div class="text-danger">{{ $message }}</div>
                   @enderror
                    </div>
