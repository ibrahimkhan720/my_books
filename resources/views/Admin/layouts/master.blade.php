...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ asset('') }}index2assets/.html" class="logo">
 ...
 @include('admin.layouts.partial.sidebar');
  ...
  <div class="content-wrapper" style="min-height: 960px;">
    ...
    <section class="content-header" style="    margin-top: -2rem;">
      <h1>
        @yield('title')
      </h1>
    </section>
...
<script src="{{ asset('') }}admin/assets/dist/js/my_script.js"></script>
...
<script>
  ...
  $('.treeview > a').click(function(e) {
    ...
    if(parentLi.hasClass('menu-open')) {
      ...
      parentLi.find('.treeview-menu').slideUp();
    } else {
      // Nahi to open karo
      parentLi.addClass('menu-open');
      parentLi.find('.treeview-menu').slideDown();
    }
  });
});
